            ...
            <div class="modal-body">
                <form id="FormCreate">
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" name="password" id="passwordedit" class="form-control @error('password') is-invalid @enderror"  value="{{ old('password') }}">
                      {!! $errors->first('password', '<small>:message</small><br>') !!}
                  </div>
                  <div class="form-group">
                    <label for="empleado">Empleado</label>
                    <select class="form-control @error('empleado_id') is-invalid @enderror" name="empleado_id" id="empleadoedit">

                    ...
                    <tbody>
                      <tr>
                        @forelse($categoria as $categorias)
                          ...
                          <td>
                            <a href="#" onclick='Mostrar({{ $categorias->id }}) ' class="btn btnT btn-success" title="Editar"
                              class="btn btn-primary" data-toggle="modal" data-target="#EditModal"><span
                                class="material-icons">create</span></a>
                            {{-- @if (auth()->check() && auth()->user()->rol == "Administrador") --}}
                            <a href="#" onclick='Eliminar({{ $categorias->id }}) ' class="btn btnT btn-danger" data-toggle="modal"
